...
var receiveSearchGiphys = function receiveSearchGiphys(giphys) {
  return {
    //giphys.data(where giphys are located)
...
/* harmony default export */ __webpack_exports__["default"] = (GiphysIndex); // function GiphysIndex({ giphys }) {
//   return (
//     <ul>
...
function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(e) {
      ...
      this.props.fetchSearchGiphys(searchTerm); //from container
    }
  }, {
    key: "render",
    value: function render() {
      var giphys = this.props.giphys; //deconstruct (same as let giphys = this.props.giphys)
...
document.addEventListener('DOMContentLoaded', function () {
  var store = Object(_store_store__WEBPACK_IMPORTED_MODULE_2__["default"])(); //calling the store

  var root = document.getElementById('root'); //calling from html
  // window.store = store;
...
/* harmony default export */ __webpack_exports__["default"] = (Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  giphys: _giphys_reducer__WEBPACK_IMPORTED_MODULE_1__["default"] //giphy reducers return giphys from receive action
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=wtzEjFNskJ2nB80MYScOuNT81X9k3YO8&limit=2")
  });
};
